...
void GraphicsPipeline::warmup(RenderingContext& ctx, const Renderer& renderer) {
    ...
    info.stageCount = 2;
    info.pStages = nullptr; // TODO
    info.pVertexInputState = &vert_input_;
    ...
    info.layout = layout_;
    info.renderPass = VK_NULL_HANDLE; // TODO
    info.subpass = 0; // TODO
